...
const Toast = ({ message, onClose, type = "success" }: ToastProps) => {
  ...
  return (
    ...
    >
      ...
      >
        {type === "success" ? <CheckMarkSuccessIcon /> : <CrossIconError />}
      </div>
      <div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-red-500  rounded-lg "></div>
