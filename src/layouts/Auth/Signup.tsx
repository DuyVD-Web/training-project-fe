...
export const Signup = () => {
    const {register, handleSubmit, formState: {errors}, setError, watch} = useForm<SignupFormInput>();
    ...
    return (
        <>
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input type="text" {...register("name", {
                        required:"Name is required"
                           ...
                           className={`bg-gray-50 border text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 
                                  ...
                                  ${errors.name ? "border-red-500" : "border-gray-300"}`}                           placeholder="Enter your name..."/>
                ...
                <div>
                    ...
                    <input type="text" {...register("email", {
                           ...
                           className={`bg-gray-50 border text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 
                                  dark:placeholder-gray-400 dark:text-white 
                                  dark:focus:ring-blue-500 dark:focus:border-blue-500
                                  ${errors.email ? "border-red-500" : "border-gray-300"}`}                           placeholder="name@gmail.com" />
                    ...
                    <input type="password" {...register("password", {
                        ...
                        minLength: {
                           ...
                           className={`bg-gray-50 border text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 
                                  dark:placeholder-gray-400 dark:text-white 
                                  dark:focus:ring-blue-500 dark:focus:border-blue-500
                                  ${(errors.password || errors.password_confirmation) ? "border-red-500" : "border-gray-300"}`}                           required/>
                    {(errors.password)  && <p className="text-red-500 pt-2">{errors.password.message}</p>}
                </div>
                <div>
                    <label htmlFor="passwordConfirmaiton"
                ...
                <input value={"Signup"} type={"submit"} className="w-full bg-blue-600 text-whi  te hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  "/>
